...
result += 11; // result = result + 11; // the variable "result" now has a value of ...
result -= 1;  // the variable now has a value of ...
result /= 3;  // the variable now has a value of ...
result *= 4;  // the variable now has a value of ...
console.log(result++); // the variable now has a value of ...
...
// 3. logical operators
console.log( (5 > 3) && (10 > 5) ); // AND operator 
console.log( (5 > 3) && (10 < 5) ); 
console.log( (5 < 3) || (10 > 5) ); // OR operator 
